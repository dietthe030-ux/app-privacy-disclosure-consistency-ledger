...
2. The selected and locked current Studio Devnet deployer/upgrader is configured actor `actor7`, public address `0x8581c4a532dd3f9b163b12809b1bd089f367147f`; its read-only readiness balance was `139.891938164499902407 GEN`. No signature or transaction was sent while selecting it. The prior `0x34b92E6553eaCA11A00A9d86d75d8a7881779D78` is historical 61999 actor data only.
